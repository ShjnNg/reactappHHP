            ...
            <div className="row px-xl-5">
              ...
              <div className="carousel-inner bg-light">
                <div className="carousel-item active">
                  <img className="w-100 h-100" src={match.attachment} alt="Image" />
                </div>
          ...
          <div className="col-lg-7 h-auto mb-30">
            <div className="h-100 bg-light p-30">
              ...
              <div className="d-flex mb-3">
                ...
                <small className="pt-1">({match.review} Reviews)</small>
              </div>
              <h3 className="font-weight-semi-bold mb-4">{match.cost.toLocaleString('it-IT', {style : 'currency', currency : 'VNĐ'})}</h3>
              <p className="mb-4">{match.content}</p>
              <div className="d-flex mb-3">
                <strong className="text-dark mr-3">Sizes: {match.size}</strong>
                
              </div>
              <div className="d-flex mb-4">
                <strong className="text-dark mr-3">Colors:{match.color}</strong>
